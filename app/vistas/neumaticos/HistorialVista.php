    ...
    <div class="col-md-12">
      <div class="box box-default">
        ...
        <div class="box-footer">
          ...
          <button class="btn btn-info pull-right" onclick="guardarHistorial()" id="boton_guardar">Guardar</button>
        </div>
        <!--div class="box-footer">
