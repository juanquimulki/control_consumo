...
<section class="content-header">
  <h1>
    Stock de Cisterna
    <small>Reporte de los movimientos de combustible de la cisterna</small>
  </h1>
</section>
    ...
    <div class="col-md-6">
      <div class="box box-default">
        ...
        <div class="box-footer">
          <button class="btn btn-default" onclick="cancelarCisterna()">Cancelar</button>
          <button class="btn btn-info pull-right" onclick="mostrarCisterna()">Mostrar</button>
