...
<section class="content-header">
  <h1>
    ...
    <small>Reporte de cargas de combustible a particulares en un período</small>
  </h1>
</section>
    ...
    <div class="col-md-6">
      <div class="box box-default">
        ...
        <div class="box-footer">
          <button class="btn btn-default" onclick="cancelarParticulares()">Cancelar</button>
          <button class="btn btn-info pull-right" onclick="mostrarParticulares()">Mostrar</button>
